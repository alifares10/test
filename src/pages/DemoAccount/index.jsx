  ...
  return (
    <>
      <div className="bg-gray_50 flex sm:flex-col md:flex-col flex-row font-gilroy gap-[30px] items-start mx-auto sm:pr-5 pr-6 w-full">
        ...
        <div className="flex-1 sm:h-[1056px] h-[1109px] md:h-[1961px] md:mt-0 mt-6 md:px-5 relative w-full">
                  ...
                  <div className="md:h-[201px] h-[350px] relative w-[96%]">
                    ...
                    <div className="absolute flex flex-col gap-11 items-start justify-start left-[0] pt-0.5 top-[0] w-[77%]">
                      ...
                      <div className="flex flex-col gap-4 items-start justify-start rounded-md w-full">
                        <Text
                          className="font-medium leading-[26.00px] text-blue_gray_400 text-left w-full"
                          variant="body1"
                        >
          ...
          <div className="absolute bg-gray_50_01 md:h-[1056px] h-[1109px] inset-y-[0] my-auto pb-[53px] right-[0] shadow-bs w-[24%]">
